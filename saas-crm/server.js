...
async function seedDatabase() {
  ...
  if (existing.rows[0].count === 0) {
    ...
    await seedCrm(adminTenant.id, [
      ...
      { name: "Global account migration", account: "Atlas Freight", contact: "Lucas Martin", email: "lucas@atlasfreight.com", owner: "Avi Stein", stage: "Won", value: 96000, close: "2026-06-06", priority: "High", group: "closed", note: "Closed after successful pilot.", updated: "Jun 6" },
    ]);
